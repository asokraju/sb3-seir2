...
class SeirEnvBeds(gym.Env):
    ...
    def __init__(
        self, 
        discretizing_time:float = 5., 
        sampling_time:float = 7., 
        sim_length:int = 175, 
        weight:float = 0.5, 
        theta:float = 113.92, 
        inital_state =  [99666., 81., 138., 115.], 
        rho_per_week:float = 0.02,
        hospital_beds_ratio:float=0.01, 
        max_hospital_cost:float = 10.,
        ...
        super(SeirEnvBeds, self).__init__()
        ...
        self.avail_hospital_beds = self.hospital_beds_ratio*self.popu
        self.max_hospital_cost = max_hospital_cost
