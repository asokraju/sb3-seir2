                ...
                do
                  ...
                  do
                    ...
                    do
                      ...
                      do
                        /afs/crc.nd.edu/user/k/kkosaraj/sb3-seir2/scripts/crc_batch.sh $test_name $env_id $weight $Senario $health_cost_scale $rho_per_week $hospital_beds_ratio $max_hospital_cost $seed $learning_rate $clip_range $rl_algo
                      done
                    done
                  done
                done
